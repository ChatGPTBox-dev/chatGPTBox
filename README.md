...
This FAQ summarizes common issues encountered by ChatGPT Box users and provides
...
### Cannot log in to ChatGPT.com with this extension active using Brave

Related issue: [#794](https://github.com/josStorer/chatGPTBox/issues/794)

Users may encounter "something went wrong" with the ChatGPT Box extension enabled.

**Possible causes:**

- The extension modifies some network requests or page content, which may
  interfere with the ChatGPT.com login flow.
- Brave browser’s built-in privacy protections (shields, blocking scripts or
  cookies) may conflict with the extension.
...
Related issues: [#786](https://github.com/josStorer/chatGPTBox/issues/786), [#757](https://github.com/josStorer/chatGPTBox/issues/757)

Gemini may work intermittently.
...
- Check if there is an updated version of the extension — newer versions may fix
  compatibility issues.

### Bilibili not working correctly

Related issues: [#732](https://github.com/josStorer/chatGPTBox/issues/732), [#703](https://github.com/josStorer/chatGPTBox/issues/703)

**Possible causes:**

- Bilibili uses dynamic page loading (SPA) and complex DOM structure, which may
  interfere with the extension’s side panel injection.
...
- Try enabling floating window mode in ChatGPTBox settings. This works better on
  sites that block side panels.
- Test on different pages, such as video pages, the homepage, and comments.
