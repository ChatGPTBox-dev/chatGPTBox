...
test('generateAnswersWithOpenAiApiCompat does not record an empty answer when stream ends before first chunk', async (t) => {
  t.mock.method(console, 'debug', () => {})
  setStorage({
    maxConversationContextLength: 3,
    maxResponseTokenLength: 256,
...
test('generateAnswersWithOpenAiApiCompat does not record an empty answer when stream only sends [DONE]', async (t) => {
  t.mock.method(console, 'debug', () => {})
  setStorage({
    maxConversationContextLength: 3,
    maxResponseTokenLength: 256,
...
test('generateAnswersWithOpenAiApiCompat does not record an empty answer when finish_reason arrives without content', async (t) => {
  t.mock.method(console, 'debug', () => {})
  setStorage({
    maxConversationContextLength: 3,
    maxResponseTokenLength: 256,
...
test('generateAnswersWithOpenAiApiCompat uses max_completion_tokens for OpenAI gpt-5 models', async (t) => {
  t.mock.method(console, 'debug', () => {})
  setStorage({
    maxConversationContextLength: 3,
...
test('generateAnswersWithOpenAICompatibleApi keeps Ollama keep_alive for materialized Ollama providers with native chat path', async (t) => {
  t.mock.method(console, 'debug', () => {})
  ...
  assert.equal(calls[0][0], 'http://127.0.0.1:11434/api/chat')
  assert.equal(calls[1][0], 'http://127.0.0.1:11434/api/generate')
})
...
test('generateAnswersWithOpenAICompatibleApi routes materialized Ollama keep_alive to request host for native path', async (t) => {
  t.mock.method(console, 'debug', () => {})
  t.mock.method(console, 'warn', () => {})
  setStorage({
    maxConversationContextLength: 3,
  ...
  assert.equal(requestedUrls.includes('http://remote-ollama:11434/api/chat'), true)
...
test('generateAnswersWithOpenAICompatibleApi prefers resolved request url for native materialized Ollama keep_alive', async (t) => {
  t.mock.method(console, 'debug', () => {})
  t.mock.method(console, 'warn', () => {})
  setStorage({
    maxConversationContextLength: 3,
...
test('generateAnswersWithOpenAICompatibleApi strips query string before native Ollama keep_alive routing', async (t) => {
  t.mock.method(console, 'debug', () => {})
  t.mock.method(console, 'warn', () => {})
  setStorage({
    maxConversationContextLength: 3,
...
test('generateAnswersWithOpenAICompatibleApi strips non-standard Ollama chat suffix before keep_alive', async (t) => {
  t.mock.method(console, 'debug', () => {})
  t.mock.method(console, 'warn', () => {})
  setStorage({
    maxConversationContextLength: 3,
  ...
  assert.equal(requestedUrls.includes('http://chat-ollama:11434/api/chat'), true)
  assert.equal(requestedUrls.includes('http://chat-ollama:11434/api/generate'), true)
  assert.equal(requestedUrls.includes('http://chat-ollama:11434/api/chat/api/generate'), false)
})
...
test('generateAnswersWithOpenAICompatibleApi keeps Ollama keep_alive for recovered Ollama sessions with native path', async (t) => {
  t.mock.method(console, 'debug', () => {})
  t.mock.method(console, 'warn', () => {})
  setStorage({
    maxConversationContextLength: 3,
  ...
  assert.equal(requestedUrls.includes('http://recovered-ollama:11434/api/chat'), true)
  assert.equal(requestedUrls.includes('http://recovered-ollama:11434/api/generate'), true)
})
