...
export const Models = {
  ...
  claudeSonnet46Api: {
    ...
    desc: 'Anthropic (API, Claude Sonnet 4.6)',
  },
  claudeHaiku45Api: {
...
export async function getUserConfig() {
  ...
  // If both old/new keys coexist (for example after Import All Data),
  // old keys take precedence so importing legacy backups restores their values.
