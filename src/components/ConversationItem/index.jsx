...
function AnswerTitle({ descName, meta }) {
  ...
  const selectedModel = meta?.selectedModel ? modelNameToDesc(meta.selectedModel, t) : ''
  const reportedModel = meta?.reportedModel ? modelNameToDesc(meta.reportedModel, t) : ''
